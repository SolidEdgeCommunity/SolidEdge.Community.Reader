...
namespace SolidEdgeContrib.Reader.Native.zlib.Zip.Compression.Streams 
{
	...
	/// as the <see cref="SolidEdgeContrib.Reader.Native.zlib.GZip.GZipInputStream">GZipInputStream</see>.
	///
