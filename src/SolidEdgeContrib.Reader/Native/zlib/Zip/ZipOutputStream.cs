...
using SolidEdgeContrib.Reader.Native.zlib.Checksums;
using SolidEdgeContrib.Reader.Native.zlib.Zip.Compression;
using SolidEdgeContrib.Reader.Native.zlib.Zip.Compression.Streams;

namespace SolidEdgeContrib.Reader.Native.zlib.Zip
{
	/// <summary>
	...
	/// using System.IO;
	/// 
	/// using SolidEdgeContrib.Reader.Native.zlib.Core;
	/// using SolidEdgeContrib.Reader.Native.zlib.Zip;
	/// 
	/// class MainClass
	/// {
    ...
    internal class ZipOutputStream : DeflaterOutputStream
	{
		...
		/// </exception>
		/// <see cref="SolidEdgeContrib.Reader.Native.zlib.Zip.Compression.Deflater"/>
