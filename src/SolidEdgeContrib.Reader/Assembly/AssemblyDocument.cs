...
namespace SolidEdgeContrib.Reader.Assembly
{
    ...
    public class AssemblyDocument : SolidEdgeDocument
    {
        ...
        //    SolidEdgeContrib.Reader.Native.IStream stream = null;

        //    if (NativeMethods.Succeeded(hr = _rootStorage.OpenStream(StreamName.Attachments, out stream)))
        //    {
        //        _attachments = SolidEdgeContrib.Reader.Assembly.Attachments.GetAttachments(stream.ToMemoryStream());
        //    }
        //}
        ...
        //            SolidEdgeContrib.Reader.Native.IStream sitesStream = null;
        //            IStorage siteStorage = null;
        //            //SolidEdgeContrib.Reader.Native.IStream oleStream = null;
        //            SolidEdgeContrib.Reader.Native.IStream propertiesStream = null;
